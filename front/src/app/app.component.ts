...
@Component({
  selector: 'app-root',
  imports: [FormsModule, ReactiveFormsModule, PollutionRecap, PollutionDetail, PollutionEdit, CommonModule, PollutionAddComponent, PollutionListComponent, UserAddComponent, UserListComponent],
